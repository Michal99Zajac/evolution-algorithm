...
def one_point(parent1: BinaryChromosome, parent2: BinaryChromosome):
    ...
    offspring1 = BinaryChromosome(parent1.gens[0:position] + parent2.gens[position:len(parent2)])
    offspring2 = BinaryChromosome(parent2.gens[0:position] + parent1.gens[position:len(parent1)])
...
def two_point(parent1: BinaryChromosome, parent2: BinaryChromosome):
    ...
    offspring1 = BinaryChromosome(parent1.gens[0:position1] + parent2.gens[position1:position2] + parent1.gens[position2:len(parent1)])
    offspring2 = BinaryChromosome(parent2.gens[0:position1] + parent1.gens[position1:position2] + parent2.gens[position2:len(parent1)])
    return offspring1, offspring2
